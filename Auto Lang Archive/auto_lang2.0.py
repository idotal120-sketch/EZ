...
def _correct_previous_word_from_keybuffer(boundary_text: str) -> bool:
    ...
    if contains_hebrew(typed):
        ...
        if typed.lower() not in COMMON_ENGLISH_WORDS and hebrew_plausible(candidate):
            corrected = candidate
